...
def get_match_data(request):
    # Your API_KEY
    api_key = "bf6aa2b3cb039f022403b5aca12635fd5d2b80c24eb3525689f91f43fd09c4d4"
    ...
    return render(request, 'main/match.html', context={'match_data':match_data,'match_error':match_error, 'competitions':competitions})
...
def match_details(request, match_id):
    ...
    querystring = {"action":"get_events","match_id":match_id,"APIkey":"bf6aa2b3cb039f022403b5aca12635fd5d2b80c24eb3525689f91f43fd09c4d4"}
